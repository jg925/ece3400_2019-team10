...
After we were able to draw squares in different locations, we had to work on drawing several squares in succession with walls. We completed this in Lab 4, as part of our full robotic integration. See the video at the bottom of this page for a working display that receives transmitted data and draws based on that data.
