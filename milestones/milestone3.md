...
A video showing our robot navigating a complex 4x5 maze is shown below. Bits of our code are also shown below that, with many declarations and functions omitted for brevity. If a function was omitted, there is a comment next to its call explaining briefly what it does.
